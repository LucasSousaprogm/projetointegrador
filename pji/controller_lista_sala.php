...
try {
    ...
    $errorMessage = "<div class=\"alerta-erro\">Erro ao carregar lista de patrimônios da sala: " . $e->getMessage() . "</div>";
    error_log("Erro ao listar patrimônio da sala: " . $e->getMessage());
}
