<?php
// Caminho: projeto integrador/controllers/controller_baixa_patrimonio.php

require '../login_logout/auth_check.php';
require "../principal/db_connect.php"; 

// session_start() é redundante se já estiver no auth_check.php, mas mantido por segurança.
...
try {
    ...
    // Redirecionamento corrigido (fica na mesma pasta, mas o destino é outro controller)
    if (!empty($salaAtual)) {
